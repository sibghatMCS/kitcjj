...
//echo $month_name.'<br/>';
$year = date('Y');
$fithlastyear = strtotime("$year. -5 year");
$fithlastyear =date('Y', $fithlastyear);

//echo $year.'<br/>';

//echo date('Y', $fithlastyear);
...
for($i=$year;$i>=$fithlastyear;$i--){
    
      echo'<a href="index.php?r=attandance/getattendyearly&year='.$i.'&id='.$_GET['id'].'">
<input class="btn btn-inverse btn-small" type="button" value="'.$i.'">
</a>';  
...
?>
    ...
    <br/>
     ...
     <h3 class="header smaller lighter blue">Record of <?php echo $sql_emp['name']; ?> FOR THE Year OF <?php echo $_GET['year']?></h3>
