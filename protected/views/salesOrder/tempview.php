...
<script type="text/javascript">
 ...
 var win = window.open('', '', 'width=1000,height=600')
win.focus();
 var divElements = document.getElementById(divID).innerText;
win.document.body.innerHTML = "<html><body>"+divElements+"</body></html>";
//win.onload = function() {
//    alert('ajsd kjash');
//  var div = win.document.createElement('div') ;
//  win.document.body = document.getElementById(divID).innerHTML;
...
$items= $command->queryAll();
    ...
    ?>
    <form id="frm11"  action="index.php?r=SalesOrder/Addordersend" method="POST">
